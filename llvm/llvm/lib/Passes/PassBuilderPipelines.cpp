...
static cl::opt<bool> EnablePerfFeatures(
    "enable-perf-features", cl::init(false), cl::Hidden,
    cl::desc(
        "Enable pass to extra performance features"));
  ...
  if (EnableModuleInliner) {
    ...
    MPM.addPass(ModuleInlinerWrapperPass(
        ...
        InlineContext{ThinOrFullLTOPhase::FullLTOPostLink,
                      InlinePass::CGSCCInliner}, UseInlineAdvisor));
  }
