...
#define INLINE_FEATURE_ITERATOR(M)                                             \
  ...
  M(int64_t, {1}, callee_users,                                                \
    ...
    "exposed externally")                                                      \
  M(int64_t, {1}, block_frequency,                                             \
    "number of callsite block frequency")                                      \
  M(int64_t, {1}, top_loop_level,                                              \
    "number of top loop level of callee")                                      \
  M(int64_t, {1}, max_caller_caller_basic_block_count,                         \
    "max number of basic blocks of the caller of caller")                      \ 
  M(int64_t, {1}, max_caller_caller_conditionally_executed_blocks,              \
    "max number of blocks reached from a conditional instruction, in the caller "  \
    "of caller")                                                               \   
  M(int64_t, {1}, if_caller_in_loop,                                           \
    "1 if the caller is in a loop, 0 otherwise")                                                         
